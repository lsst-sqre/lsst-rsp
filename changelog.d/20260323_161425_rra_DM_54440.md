...
- Add new `RSPServices` class for service discovery, creation of PyVO clients for specific services, and creation of requests sessions that are configured to send appropriate authentication credentials on all requests.
